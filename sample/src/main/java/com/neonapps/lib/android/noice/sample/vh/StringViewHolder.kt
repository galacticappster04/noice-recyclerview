package com.neonapps.lib.android.noice.sample.vh
...
class StringViewHolder(binding : ListitemStringBinding) : BindingTypedHolder<ListitemStringBinding>(binding, TYPE.String)